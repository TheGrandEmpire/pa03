 ...
 *
 * It also holds the velocity vx and vy of the circle in terms of
 ...
 * We assume the circles are on a rectangular board which limits their movement
 */
public class CircleShape {
    ...
    public Color color;   // The color of the circle.
		protected double vx=30;
		protected double vy=15;
